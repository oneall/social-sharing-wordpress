...
class oa_social_sharing_icons {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      oa_social_sharing_icons_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - oa_social_sharing_icons_Loader. Orchestrates the hooks of the plugin.
	 * - oa_social_sharing_icons_i18n. Defines internationalization functionality.
	 * - oa_social_sharing_icons_Admin. Defines all hooks for the admin area.
	 * - oa_social_sharing_icons_public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the oa_social_sharing_icons_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    oa_social_sharing_icons_Loader    Orchestrates the hooks of the plugin.
	 */
