...
class oa_social_sharing_icons_admin_widget extends WP_Widget
{
	...
	*/
	public function widget ($args, $instance)
	{
		...
		//Content
		echo $this->oa_social_sharing_icons_render_sharing_form ($instance);
	}
	 ...
	 * @param  array  $instance widget values
	 * @return string widget settings form values
	 */
	public function oa_social_sharing_icons_render_sharing_form ($instance = array ())
	{
		...
		if (!empty ($api_subdomain))
		{
			...
			$output = $oa_social_sharing_icons_public->print_sharing_bloc('widget', $button_size);
